...
\item Choose an angle theta uniformly in $[]$
...
\begin{lemma}
Considering the previous process, with a finite two-colouring, the probability that both ends of the needle fall on the same colour is at least : $$ \frac13 - \frac{\mathcal{P}}{\mathcal{A}} $$
