...
easily shows that all of the inequalities obtained are true for $p$, especially
...
the (impossible) idea of ``throwing a needle uniformly on the whole plane'', by 
considering what we may call an asymptotic probability.
