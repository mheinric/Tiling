...
\end{theo*}
We don't know if the left hand of the unequality is actually an equality in
...
The unequality of theorem~\ref{ineg2} should nevertheless remain true for these different possible values of asymptotic $p(c)$'s.
