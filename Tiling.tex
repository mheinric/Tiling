...
but $\pper(c)$ and $p(c)$ may differ in that case. This will be discussed 
thereafter.
%%%%%%%
...
\end{theo}
The rest of the paper aims at proving the equivalent theorem for asymptotic 
...
$$A' = e^{i.\theta} z_J + A_0, \ B' = e^{i.\theta} (z_J + e^{i.\theta_J}) + A_J.$$
\end{process}
